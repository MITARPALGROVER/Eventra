...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const passwordToggle = document.querySelector('.show-password-btn');
  
  if (passwordToggle) {
    passwordToggle.addEventListener('click', () => {
      // Find the password input in the same passwordBox container
      const passwordBox = passwordToggle.closest('.passwordBox');
      const passwordInput = passwordBox.querySelector('input[type="password"], input[type="text"]');
      const eyeIcon = passwordToggle.querySelector('.show-password-icon');
